...
def get_data(txt_file, ann_file, entity_label_pairs, statistics):
...
def create_re_data():
    # Prepare data and perform relation statistics
    case_num, statistics = prepare_data()
    print('statistics: {}'.format(statistics))
    print('case_num: {}'.format(case_num))

    # Statistics based on actual sentence-level
    data_num, statistics_actual = get_actual_statistics()
    print('data_num: {}'.format(data_num))
    print('statistics_actual: {}'.format(statistics_actual))
    ...
    # draw_histogram(statistics_actual)
